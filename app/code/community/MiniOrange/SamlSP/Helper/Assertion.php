...
class SAML2_Assertion
{
    ...
    public function __construct(DOMElement $xml = NULL)
    {
		...
		if($xml->localName === 'EncryptedAssertion'){
				...
				$url =  Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_SKIN). 'adminhtml/default/default/miniorangesamlsp/resources/sp-key.key';
				$key->loadKey($url,TRUE);
				
				$alternateKey = new XMLSecurityKey($algo, array('type' => 'private'));
				$alternateKeyUrl = Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_SKIN). 'adminhtml/default/default/miniorangesamlsp/resources/miniorange_sp_priv_key.key';
